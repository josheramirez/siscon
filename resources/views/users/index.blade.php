...
<div class="container-fluid">
	...
	@elseif($message == 'especialidades')
		<div class="alert alert-success alert-dismissible" role="alert">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			Especialidades Asignadas Exitosamente
		</div>	
	@endif
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<form class="form-horizontal" role="form" method="GET" action="{{ URL::to('users/reporte/excel') }}">
						...
						<div class="col-md-6 col-md-offset-2">
							<form class="form-horizontal" role="form" method="GET" action="{{ URL::to('users') }}">
								<div class="input-group">
									<input id="search" name="search" 	type="text" class="form-control input-sm" placeholder="Buscar por Nombre de Usuario">
								...
								<tbody>
								  ...
								  <tr>
									...
									<td><a href="{{ URL::to('users/asignRole/' . $user->id ) }}">Roles</a> | 
										...
										<a href="{{ URL::to('users/asignEspec/' . $user->id ) }}">Especialidades</a></td>
								  </tr>
								  @endforeach
								</tbody>
							</table>
