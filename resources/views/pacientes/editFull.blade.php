                ...
                <div class="panel-body">
					<form class="form-horizontal" role="form" method="POST" action="{{ URL::to('pacientes') }}/{{$paciente->id}}">
						...
						<div class="col-md-6">
								...
								<div class="col-md-8">
									<select id="tipoDoc" class="form-control" name="tipoDoc" required>
										...
										@else
											...
											<option value="2" selected>Pasaporte / Otro</option>
										@endif	
									</select>
								</div>
							</div>
							...
							@else
							<div class="form-group{{ $errors->has('run') ? ' has-error' : '' }}" id="divRun" hidden>	
							@endif		
								<label for="run" class="col-md-4 control-label">R.U.N.</label>

								<div class="col-md-8">
									@if ($paciente->tipoDoc == 1)
										<input id="run" type="text" class="form-control" name="run" value="{{$paciente->rut}}-{{$paciente->dv}}" onchange="validaRut()" required autofocus>
									@else
										<input id="run" type="text" class="form-control" name="run" value="" onchange="validaRut()" placeholder="12345678-9" autofocus>	
									@endif		
							...
							<!--Numero de Documento-->
							@if ($paciente->tipoDoc == 2)
							<div class="form-group{{ $errors->has('numDoc') ? ' has-error' : '' }}"  id="divNumDoc">
							@else	
							...
							@endif
								...
								<div class="col-md-8">
									@if ($paciente->tipoDoc == 2)
										<input id="numDoc" type="text" class="form-control" name="numDoc" value="{{ $paciente->numDoc }}" required autofocus>
									@else
										<input id="numDoc" type="text" class="form-control" name="numDoc" value="" autofocus>
									@endif								
							...
							<div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									<input id="nombre" type="text" class="form-control" name="nombre" value="{{ $paciente->nombre }}" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" required autofocus>
							...
							<div class="form-group{{ $errors->has('apPaterno') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									<input id="apPaterno" type="text" class="form-control" name="apPaterno" value="{{ $paciente->apPaterno }}" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" required autofocus>
							...
							<div class="form-group{{ $errors->has('apMaterno') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									<input id="apMaterno" type="text" class="form-control" name="apMaterno" value="{{ $paciente->apMaterno }}" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" required autofocus>
						...
						<div class="col-md-6">
							...
							<input name="url" id="url" type="hidden" value="su">
