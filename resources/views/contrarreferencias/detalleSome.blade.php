                ...
                <div class="panel-body">
					...
					<div id="infoPaciente" class="collapse in">
						<div class="row row-padding">
							...
							<div class="col-xs-12 col-sm-6 col-xs-12 col-sm-6 col-md-2">
							...
							<div class="col-xs-12 col-sm-6 col-xs-1 col-sm-1 col-md-1">
					...
					<div class="row row-padding">
						<div class="col-xs-1 col-sm-1 col-md-1">
							<a class="btn btn-sm btn-primary" href="{{ URL::to('contrarreferencias/'. $contrarreferencia->id. '/actualizar') }}">Actualizar</a>
						</div>
					</div>
				</div>
            </div>
